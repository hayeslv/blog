...
<template>
  <div class="echart-wrap">
    <PanelBac title="柱状图 + 折线图" :height="210">
...
const demoList = [
  { name: '当年完成水量', value1: 4.2, value2: 5 },
  { name: '去年同期水量', value1: 5, value2: 6 },
  { name: '滚动目标值水量', value1: 7, value2: 7 },
  { name: '全年目标值水量', value1: 2, value2: 2 },
  { name: '当年完成金额', value1: 3, value2: 3 },
  { name: '去年同期金额', value1: 4.2, value2: 5 },
  { name: '滚动目标金额', value1: 4.2, value2: 5 },
